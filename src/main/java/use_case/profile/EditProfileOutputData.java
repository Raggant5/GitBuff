...
public class EditProfileOutputData {
    ...
    public EditProfileOutputData(String username, float height, float weight,
                                 ActivityLevel activityLevel, FitnessGoal goal,
                                 String profilePicturePath, LocalDate dateOfBirth,
                                 Gender gender, String bio, UnitSystem preferredUnitSystem,
                                 Set<Equipment> equipment, Set<DietaryRestriction> dietaryRestrictions,
                                 Set<DayOfWeek> preferredWorkoutDays, int preferredWorkoutDurationMinutes,
